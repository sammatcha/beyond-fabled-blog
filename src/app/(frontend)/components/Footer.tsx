    ...
    return(
        <div className="w-full ">
            <div className="px-6 justify-between flex items-center ">
                <p>&copy; Beyond Fabled 2025</p>
                <div className="cursor-pointer flex ">
                    {/* tiktok */}
                    <a href="https://www.tiktok.com/@beyond.fabled" target="_blank" rel="noopener noreferrer">
                    <span>
                        <Image src="/image/tt-icon.png" alt="socials tiktok icon" width={40} height={40}/>
                    </span>
                    </a>
                    {/* instagram */}
                     <a href="https://www.instagram.com/beyond.fabled/#" target="_blank" rel="noopener noreferrer">
                    <span>
                        <Image src="/image/ig-icon.png" alt="socials instagram icon" width={40} height={40}/>
                    </span>
                    </a>
                    {/* youtube */}
                      <a href="https://www.youtube.com/@beyondfable" target="_blank" rel="noopener noreferrer">
                    <span>
