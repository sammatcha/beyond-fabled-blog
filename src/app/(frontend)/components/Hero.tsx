            ...
            <div className='flex flex-col md:flex-row w-full justify-center items-center max-w-6xl mx-auto'>
                  ...
                  <div className=' '>
                    <div className='relative w-[55vw] min-w-[350px] max-w-[600px]'>
                        <Image src="/image/hero-bg-wash.png" alt="hero wash" width={600} height={600} className="opacity-80 object-cover h-auto "/>
              ...
              <div className=' max-w-full  '>
                <div className='relative  w-[30vw] min-w-[180px] max-w-[400px] '>
                    <Image src="/image/hero-bg-bubble1.png" alt="hero bubbles" width={400} height={400} className="object-contain lg:object-cover h-auto "/>
